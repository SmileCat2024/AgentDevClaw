const I18N = {
  zh: {
    ...
    feature_hooks: 'hooks',
    feature_tools: 'tools',
    feature_cat_tools: '工具',
    feature_cat_policy: '策略与守卫',
    feature_cat_commands: '命令',
    feature_cat_skills: '技能',
    feature_cat_gateway: '消息渠道',
    feature_cat_mcp: 'MCP',
    feature_cat_protocol: '宿主协议',
  ...
  en: {
    ...
    feature_hooks: 'hooks',
    feature_tools: 'tools',
    feature_cat_tools: 'Tools',
    feature_cat_policy: 'Policies & Guards',
    feature_cat_commands: 'Commands',
    feature_cat_skills: 'Skills',
    feature_cat_gateway: 'Gateway Channels',
    feature_cat_mcp: 'MCP',
    feature_cat_protocol: 'Host Protocol',
