const I18N = {
  zh: {
    ...
    feature_enabled: '已启用',
    feature_partial: '部分启用',
    feature_disabled: '已禁用',
    feature_removed: '已移除',
    feature_hooks: 'hooks',
    feature_tools: 'tools',
    feature_cap_tools: '工具',
    feature_cap_policy: '策略与守卫',
    feature_cap_commands: '命令',
    feature_cap_skills: '技能',
    feature_cap_gateway: '消息渠道',
    feature_cap_mcp: 'MCP',
    feature_cap_protocol: '宿主协议',
    feature_cat_unmapped: '待归类',
    feature_type_ability: '能力',
    feature_type_governance: '会话与行为',
    ...
    feature_filter_empty_cap: '该能力下暂无 feature',
    feature_mounted_title: '已挂载',
    feature_prov_builtin: '框架',
    feature_prov_ecosystem: '生态',
    feature_prov_local: 'Claw',
    feature_prov_inline: '宿主',
    feature_prov_packaged: '已安装',
    ...
    rcon_readonly_placeholder: '远程操作将在下一阶段开放',
    rcon_group_header: '远程工作空间',
    rcon_banner_disconnected: '远程连接已断开，以下为最后已知内容',
    rcon_banner_degraded: '远程连接异常，数据可能不完整',
    rcon_banner_connecting: '正在连接远程服务器…',
    rcon_last_online: '最后在线',
    rcon_flyout_servers: '远程服务器',
    rcon_mgr_title: '远程服务器',
    rcon_mgr_subtitle: '连接其他 Claw 实例，只读查看其工作空间。',
    rcon_mgr_add: '添加服务器',
    rcon_mgr_empty: '尚未配置任何远程服务器。点击“添加服务器”创建第一条连接。',
    rcon_mgr_refresh: '刷新',
    rcon_mgr_edit: '编辑',
    rcon_mgr_delete: '删除',
    rcon_mgr_handshake: '立即握手',
    rcon_mgr_tunnel_diag: '隧道诊断（SSH stderr 尾部）',
    rcon_mgr_manual_hint_title: '手动模式说明',
    rcon_mode_manual: '手动隧道',
    rcon_mode_managed: '托管隧道',
    rcon_mode_url: '直连地址',
    rcon_field_base_url: '远程地址',
    rcon_url_hint_title: '直连模式说明',
    rcon_url_hint_body: '远程实例经 HTTP(S) 直接可达时使用：填写远程 Claw 的源地址（如 https://claw.example.com，不带路径）。Claw 直接向该地址探测握手并只读拉取工作空间，无需 SSH 隧道与本地端口。',
    rcon_field_local_port: '本地端口',
    rcon_field_ssh_host: 'SSH 主机',
    rcon_field_ssh_user: 'SSH 用户',
    rcon_field_ssh_port: 'SSH 端口',
    rcon_field_host_alias: 'SSH Host 别名（可选）',
    rcon_field_app_port: '远程应用端口',
    rcon_field_auth_password: '访问密码（可选）',
    rcon_field_auth_keep: '已配置，留空保持不变',
    rcon_field_auth_hint: '远程开启访问保护时填写',
    rcon_auth_configured: '已配置访问密码',
    rcon_state_configured: '待连接',
    rcon_state_connecting: '握手中',
    rcon_state_connected: '已连接',
    rcon_state_reconnecting: '重连中',
    rcon_state_disconnected: '已断开',
    rcon_state_degraded: '已降级',
    rcon_mgr_manual_hint_body: '手动模式下请自行建立 SSH 本地转发隧道，例如：ssh -N -L 127.0.0.1:22101:127.0.0.1:1420 user@host。Claw 将通过本地端口向远程实例探测握手并只读拉取工作空间目录；隧道断开时列表会标记连接状态。',
    rcon_mgr_version_warn: '版本不匹配',
    rcon_mgr_delete_confirm: '再次点击确认删除',
    rcon_mgr_no_handshake: '尚未握手',
    rcon_mgr_save: '保存',
    rcon_mgr_cancel: '取消',
    rcon_tunnel_up: '隧道运行中',
    rcon_tunnel_down: '隧道停止',
    rcon_tunnel_starting: '隧道启动中',
    rcon_tunnel_stopped: '隧道未启动',
    rcon_entry_disabled_hint: '该连接当前不可用，无法打开远程工作空间视图',
    rcon_mgr_error_name_required: '请填写别名',
    rcon_mgr_error_id_required: '请填写连接 ID',
    rcon_mgr_error_port_required: '请填写本地端口（1-65535 整数）',
    rcon_mgr_error_port_invalid: '端口必须是 1-65535 的整数',
    rcon_mgr_error_ssh_host: '托管模式必须填写 SSH 主机',
    rcon_mgr_error_base_url_required: '请填写远程地址（http/https）',
    rcon_mgr_error_base_url_invalid: '远程地址必须是 http(s) 源地址（如 https://claw.example.com，不带路径）',
  ...
  en: {
    ...
    feature_hooks: 'hooks',
    feature_tools: 'tools',
    feature_cap_tools: 'Tools',
    feature_cap_policy: 'Policies & Guards',
    feature_cap_commands: 'Commands',
    feature_cap_skills: 'Skills',
    feature_cap_gateway: 'Gateway Channels',
    feature_cap_mcp: 'MCP',
    feature_cap_protocol: 'Host Protocol',
    feature_cat_unmapped: 'Unmapped',
    feature_type_ability: 'Abilities',
    feature_type_governance: 'Session & Behavior',
    feature_type_interface: 'Channels & Interaction',
    feature_type_system: 'System',
    feature_filter_all: 'All',
    feature_filter_bundled: 'Bundled',
    feature_filter_installed: 'Installed',
    feature_filter_empty_installed: 'No installed features yet',
    feature_filter_empty: 'No features under this filter',
    feature_filter_empty_cap: 'No features with this capability',
    feature_mounted_title: 'Mounted',
    feature_prov_builtin: 'Framework',
    feature_prov_ecosystem: 'Ecosystem',
    feature_prov_local: 'Claw',
    feature_prov_inline: 'Inline',
    feature_prov_packaged: 'Installed',
    ...
    rcon_readonly_placeholder: 'Remote actions will open in a later phase',
    rcon_group_header: 'Remote Workspaces',
    rcon_banner_disconnected: 'Remote connection lost — showing last known content',
    rcon_banner_degraded: 'Remote connection degraded — data may be incomplete',
    rcon_banner_connecting: 'Connecting to remote server…',
    rcon_last_online: 'Last online',
    rcon_flyout_servers: 'Remote servers',
    rcon_mgr_title: 'Remote Servers',
    rcon_mgr_subtitle: 'Connect other Claw instances and view their workspaces read-only.',
    rcon_mgr_add: 'Add Server',
    rcon_mgr_empty: 'No remote servers configured yet. Click "Add Server" to create the first connection.',
    rcon_mgr_refresh: 'Refresh',
    rcon_mgr_edit: 'Edit',
    rcon_mgr_delete: 'Delete',
    rcon_mgr_handshake: 'Handshake now',
    rcon_mgr_tunnel_diag: 'Tunnel diagnostics (SSH stderr tail)',
    rcon_mgr_manual_hint_title: 'About manual mode',
    rcon_field_name: 'Alias',
    rcon_field_conn_id: 'Connection ID',
    rcon_field_enabled: 'Enable this connection',
    rcon_field_mode: 'Mode',
    rcon_mode_manual: 'Manual tunnel',
    rcon_mode_managed: 'Managed tunnel',
    rcon_mode_url: 'Direct URL',
    rcon_field_base_url: 'Remote URL',
    rcon_url_hint_title: 'About direct URL mode',
    rcon_url_hint_body: 'Use this when the remote instance is reachable over plain HTTP(S): enter the origin of the remote Claw (e.g. https://claw.example.com, no path). Claw probes and fetches workspace catalogs directly from that address — no SSH tunnel or local port needed.',
    rcon_field_local_port: 'Local port',
    rcon_field_ssh_host: 'SSH host',
    rcon_field_ssh_user: 'SSH user',
    rcon_field_ssh_port: 'SSH port',
    rcon_field_host_alias: 'SSH host alias (optional)',
    rcon_field_app_port: 'Remote app port',
    rcon_field_auth_password: 'Access password (optional)',
    rcon_field_auth_keep: 'Configured — leave blank to keep',
    rcon_field_auth_hint: 'Fill in when the remote enables access protection',
    rcon_auth_configured: 'Access password configured',
    rcon_state_configured: 'Configured',
    rcon_state_connecting: 'Handshaking',
    rcon_state_connected: 'Connected',
    rcon_state_reconnecting: 'Reconnecting',
    rcon_state_disconnected: 'Disconnected',
    rcon_state_degraded: 'Degraded',
    rcon_mgr_manual_hint_body: 'In manual mode you build the SSH local forward yourself, e.g.: ssh -N -L 127.0.0.1:22101:127.0.0.1:1420 user@host. Claw probes the remote instance through the local port for handshakes and fetches workspace catalogs read-only; the sidebar marks connections when tunnels drop.',
    rcon_mgr_version_warn: 'Version mismatch',
    rcon_mgr_delete_confirm: 'Click again to confirm delete',
    rcon_mgr_no_handshake: 'No handshake yet',
    rcon_mgr_save: 'Save',
    rcon_mgr_cancel: 'Cancel',
    rcon_tunnel_up: 'Tunnel running',
    rcon_tunnel_down: 'Tunnel stopped',
    rcon_tunnel_starting: 'Tunnel starting',
    rcon_tunnel_stopped: 'Tunnel not started',
    rcon_entry_disabled_hint: 'This connection is unavailable; the remote workspace view cannot be opened',
    rcon_mgr_error_name_required: 'Alias is required',
    rcon_mgr_error_id_required: 'Connection ID is required',
    rcon_mgr_error_port_required: 'Local port is required (integer 1-65535)',
    rcon_mgr_error_port_invalid: 'Port must be an integer between 1 and 65535',
    rcon_mgr_error_ssh_host: 'Managed mode requires an SSH host',
    rcon_mgr_error_base_url_required: 'Remote URL is required (http/https)',
    rcon_mgr_error_base_url_invalid: 'Remote URL must be an http(s) origin (e.g. https://claw.example.com, no path)',
