...
function applyLanguage() {
  ...
  const settingsAuthItem = document.getElementById('settings-flyout-auth');
  ...
  if (settingsAuthItem) settingsAuthItem.textContent = currentLanguage === 'zh' ? '访问保护' : 'Access protection';
