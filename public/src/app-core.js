...
const I18N = {
  zh: {
    ...
    standalone_tools_title: '额外工具',
    standalone_tools_desc: '不属于任何 Feature 的直接注册工具',
    feature_tool_render: 'render',
    feature_tool_schema: '查看 Schema',
    feature_tool_schema_expanded: '收起 Schema',
    feature_open_details: '查看详情',
    feature_toggle_hint: '启用 / 禁用',
    ...
    runtime_status_cancelled: '本轮调用已停止',
  ...
  en: {
    ...
    standalone_tools_title: 'Standalone Tools',
    standalone_tools_desc: 'Directly registered tools not belonging to any Feature',
    feature_tool_render: 'render',
    feature_tool_schema: 'View schema',
    feature_tool_schema_expanded: 'Hide schema',
    feature_open_details: 'Open details',
    feature_toggle_hint: 'Enable / Disable',
    ...
    runtime_status_cancelled: 'This call was stopped',
