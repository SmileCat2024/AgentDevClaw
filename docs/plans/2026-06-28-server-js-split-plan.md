...
> 创建日期：2026-06-28
> 状态：历史拆分计划（阶段性记录；其中路径示例不代表当前配置落点）
> 应用配置现位于 Claw 用户数据目录；迁移契约见 [应用配置与用户数据边界收敛计划](./2026-09-25-app-config-and-data-boundaries.md)。
...
| 9 | workspace (state + data + 3 routes) | ✅ 完成 | 3,022 → 2,171 | 2026-06-29 |
| 10 | workspace-creators (helpers + 2 routes) | ✅ 完成 | 2,171 → 1,816 | 2026-06-30 |
| 11 | agent-discovery + identity (helpers + 2 routes) | ✅ 完成 | 1,816 → 1,460 | 2026-06-30 |
